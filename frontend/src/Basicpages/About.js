  ...
  return (
   <>
      ...
      <section className="team-section">
        <div className="container">
          <h2 className="text-center mb-5">Meet The Architects</h2>
          <div className="team-grid d-flex flex-wrap justify-content-center">
            {/* Team Member 1 */}
            <div className="team-member">
              <div className="team-card">
                <img
                  src="http://static.photos/people/640x360/101"
                  alt="CEO"
                  className="img-fluid"
                />
                <div className="team-card-content">
                  ...
                  <p className="description">
                    Former HR Director with 15 years experience in corporate HR
                    transformation
                  </p>
            ...
            <div className="team-member">
              <div className="team-card">
                <img
                  src="http://static.photos/people/640x360/102"
                  alt="CTO"
                  className="img-fluid"
                />
                <div className="team-card-content">
                  ...
                  <p className="description">
                    Tech visionary who previously built HR systems for Fortune
                    500 companies
                  </p>
                  <div className="social-links">
                    <a href="#">
            ...
            <div className="team-member">
              <div className="team-card">
                <img
                  src="http://static.photos/people/640x360/103"
                  alt="CPO"
                  className="img-fluid"
                />
                <div className="team-card-content">
                  <h3>David Rodriguez</h3>
                  <p className="position">CPO & Co-founder</p>
                  <p className="description">
                    Product genius who simplifies complex HR processes into
                    intuitive workflows
                  </p>
                  <div className="social-links">
                    <a href="#">
