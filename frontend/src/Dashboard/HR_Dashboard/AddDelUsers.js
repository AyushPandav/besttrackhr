...
function AddDelUsers() {
  ...
  const SPRINGBOOT_URL =
    "https://6908882f2d902d0651b0b8b2.mockapi.io/mysql-server-localhost/users";
  const SPRING_BOOT_URL = "http://localhost:8080"; // Replace with your backend ping endpoint
