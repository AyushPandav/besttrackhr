        ...
        <div className="container">
          <div className="about-content">
            <div className="about-text" data-aos="fade-right">
              <h2 className="about-title">Why Choose BestTrackHR?</h2>
      ...
      <section className="testimonials-section">
        <div className="container">
          <div className="section-header" data-aos="fade-up">
            ...
            <p className="section-subtitle">
              See what our customers have to say about their experience with BestTrackHR.
            </p>
          </div>
          ...
          <div className="testimonials-grid">
            <div className="testimonial-card" data-aos="fade-up" data-aos-delay="100">
              <div className="testimonial-content">
                ...
                <p className="testimonial-text">
                  "BestTrackHR transformed our HR operations completely. The Google integration 
            ...
            <div className="testimonial-card" data-aos="fade-up" data-aos-delay="300">
              <div className="testimonial-content">
                ...
                <p className="testimonial-text">
                  "As a growing startup, we needed scalable HR tools. BestTrackHR grew with us 
        ...
        <div className="container">
          <div className="cta-content" data-aos="fade-up">
            ...
            <p className="cta-subtitle">
              Join thousands of companies who trust BestTrackHR to manage their most valuable asset - their people.
            </p>
